...
@Composable
fun ContractionCounterScreen(viewModel: ContractionCounterViewModel, navController: NavController,
                             openDrawer: () -> Unit) {
    PhdLayoutMenu(
        ...
        {
            CounterContractionComponent(navController, viewModel)
        }
    }
}
...
@RequiresApi(Build.VERSION_CODES.O)
@Composable
fun CounterContractionComponent(navController: NavController, viewModel: ContractionCounterViewModel = androidx.lifecycle.viewmodel.compose.viewModel()) {
    ...
    Column(
        ...
        Button(
            onClick = { navController.navigate(NavRoutes.CONTRACTION_COUNTER_REPORTS) },
            colors = ButtonDefaults.buttonColors(
                containerColor = primaryYellow,
